...
#define  OS_CPU_EXCEPT_STK_SIZE    128u          /* Default exception stack size is 128 CPU_STK entries */
#endif
...
/* PVH_ADD: need to define this */
#define OS_TS_GET() 5 /* PVH_NOTE: I beleive we should use RTC_CounterGet() for this */
