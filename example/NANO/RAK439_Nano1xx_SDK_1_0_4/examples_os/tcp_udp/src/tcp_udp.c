...
#ifdef  TCPS_TEST
#define   RW_TCPS_TASK_PRIO            6
#define   RW_TCPS_TASK_STACK_SIZE      200U
static    CPU_STK  g_tcpserver_task_stack[RW_TCPS_TASK_STACK_SIZE]; 
static    OS_TCB   g_tcpserver_task;
#endif

#ifdef  TCPC_TEST 
#define   RW_TCPC_TASK_PRIO            6
#define   RW_TCPC_TASK_STACK_SIZE      200U
static    CPU_STK  g_tcpclient_task_stack[RW_TCPC_TASK_STACK_SIZE];
static    OS_TCB   g_tcpclient_task;
#endif

#ifdef  UDPS_TEST
#define   RW_UDPS_TASK_PRIO            6
#define   RW_UDPS_TASK_STACK_SIZE      200U
static    CPU_STK  g_udpserver_task_stack[RW_UDPS_TASK_STACK_SIZE]; 
static    OS_TCB   g_udpserver_task;
#endif

#ifdef  UDPC_TEST
#define   RW_UDPC_TASK_PRIO            6
#define   RW_UDPC_TASK_STACK_SIZE      200U
static    CPU_STK  g_udpclient_task_stack[RW_UDPC_TASK_STACK_SIZE]; 
static    OS_TCB   g_udpclient_task;
#endif
...
int creat_tcpsTask(void)
{
    OS_ERR oserr;
    /* Create the task                         */
    OSTaskCreate(&g_tcpserver_task,                                        // TCB
                 "TcpServer_EventHandle",                              // name
                 RAK_TcpServer_EventHandle,                            // func
                 NULL,                                              // func(arg)
                 RW_TCPS_TASK_PRIO,                                 // priority
                 &g_tcpserver_task_stack[0],                              // stack
                 RW_TCPS_TASK_STACK_SIZE/10,                       // stack lim
                 RW_TCPS_TASK_STACK_SIZE,                          // stack sz
                 0,                                               // msq Q
                 1000,                                               // time quanta
                 NULL,                                            // ext ptr
...
int creat_tcpcTask(void)
{
    OS_ERR oserr;
    /* Create the task                         */
    OSTaskCreate(&g_tcpclient_task,                                        // TCB
                 "TcpServer_EventHandle",                              // name
                 RAK_TcpClient_EventHandle,                            // func
                 NULL,                                              // func(arg)
                 RW_TCPS_TASK_PRIO,                                 // priority
                 &g_tcpclient_task_stack[0],                              // stack
                 RW_TCPC_TASK_STACK_SIZE/10,                       // stack lim
                 RW_TCPC_TASK_STACK_SIZE,                          // stack sz
                 0,                                               // msq Q
                 1000,                                               // time quanta
                 NULL,                                            // ext ptr
                 (OS_OPT_TASK_STK_CHK | OS_OPT_TASK_STK_CLR),     // opt(s)
...
int creat_udpsTask(void)
{
    OS_ERR oserr;
    /* Create the task                         */
    OSTaskCreate(&g_udpserver_task,                                        // TCB
                 "TcpServer_EventHandle",                              // name
                 RAK_UdpServer_EventHandle,                            // func
                 NULL,                                              // func(arg)
                 RW_UDPS_TASK_PRIO,                                 // priority
                 &g_udpserver_task_stack[0],                              // stack
                 RW_UDPS_TASK_STACK_SIZE/10,                       // stack lim
                 RW_UDPS_TASK_STACK_SIZE,                          // stack sz
                 0,                                               // msq Q
                 1000,                                               // time quanta
                 NULL,                                            // ext ptr
                 (OS_OPT_TASK_STK_CHK | OS_OPT_TASK_STK_CLR),     // opt(s)
...
int creat_udpcTask(void)
{
    OS_ERR oserr;
    /* Create the task                         */
    OSTaskCreate(&g_udpclient_task,                                        // TCB
                 "TcpServer_EventHandle",                              // name
                 RAK_UdpClient_EventHandle,                            // func
                 NULL,                                              // func(arg)
                 RW_UDPC_TASK_PRIO,                                 // priority
                 &g_udpclient_task_stack[0],                              // stack
                 RW_UDPC_TASK_STACK_SIZE/10,                       // stack lim
                 RW_UDPC_TASK_STACK_SIZE,                          // stack sz
                 0,                                               // msq Q
                 1000,                                               // time quanta
                 NULL,                                            // ext ptr
                 (OS_OPT_TASK_STK_CHK | OS_OPT_TASK_STK_CLR),     // opt(s)
